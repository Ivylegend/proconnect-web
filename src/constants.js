...
export const Denmark = [{ id: 0, name: "Copenhagen Business School" }];
...
export const Switzerland = [{ id: 0, name: "IMD Business School" }];
...
export const SouthAfrica = [{ id: 0, name: "University of Cape Town" }];
...
export const faqs = [
  {
    question: "What is the Proconnect International Student Loan?",
    answer:
      "Proconnect provides international study abroad loans for students seeking to study in 17 countries. The 17 countries are as follows: United States, Canada, United Kingdom (Scotland, Wales, Northern Ireland and England), Hong Kong, Singapore, France, Germany, Australia, South-Africa, China, Denmark, Belgium, Spain, Italy, Switzerland, Netherlands, and Portugal. The loan amount can be up to $100,000, depending on the course and destination country.",
  },
  {
    question: "Who is eligible for the Proconnect International Student Loan?",
    answer:
      "Any individual from across the world planning to study in one of the supported countries above is eligible. Specific criteria include admission to a partner university and compliance with Proconnect’s documentation requirements.",
  },
  {
    question: "What countries are covered under this loan program?",
    answer:
      "The loan covers a wide range of countries, including the United States, Canada, United Kingdom (Scotland, Wales, Northern Ireland and England), Hong Kong, Singapore, France, Germany, Australia, South-Africa, China, Denmark, Belgium, Spain, Italy, Switzerland, Netherlands, and Portugal.",
  },
  {
    question: "What is the process of applying for the loan?",
    answer:
      "The loan application process includes submitting required documents, undergoing a due diligence check, securing admission from a partner university, receiving a conditional approval, and getting a letter of financial support.",
  },
  {
    question: "What is the maximum loan amount I can apply for?",
    answer:
      "You can apply for up to $100,000 for international study programs, depending on your course and university. For programs lasting two years, the full amount is available; otherwise, the maximum per session is $50,000.",
  },
  {
    question:
      "Do I need to be admitted into a university before applying for the loan?",
    answer:
      "Yes, admission to one of Proconnect's partner universities is required for loan approval. Proconnect also assists in securing the right admission to ensure eligibility for the loan. While funding policies may occasionally change due to our financial partners’ guidelines for specific schools, courses, or countries, such changes are rare.",
  },
  {
    question: "Does Proconnect help with university admissions?",
    answer:
      "Yes, Proconnect assists students in securing admission into one of its partner universities and provides support throughout the admission process.",
  },
  {
    question: "What documents are required for the loan application?",
    answer:
      "The loan application requires personal identification, proof of admission, financial documents, and academic transcripts, among others. A specific checklist is provided during the application process.",
  },
  {
    question: "How long does it take to get the loan approved?",
    answer:
      "The loan approval process generally takes several weeks, depending on the completeness of documentation and the university’s timeline.",
  },
  {
    question: "Is the loan available to students from any country?",
    answer:
      "Yes, the loan is available to students from all eligible countries. However, it is not accessible to those from countries that are sanctioned and restricted from global financing services.",
  },
  {
    question: "What is the interest rate on the loan?",
    answer:
      "Interest rates on the loan range from 10% to 16% per annum. The specific rate you are offered depends on your credit history during the application process.",
  },
  {
    question: "Can the loan be used for both tuition and living expenses?",
    answer:
      "Yes, the loan can cover both tuition and living expenses, including accommodation, books, and travel, if you are studying in the United States or selected universities in Canada. However, for countries like the United Kingdom, Hong Kong, Singapore, and others, the loan will only cover tuition and not living expenses.",
  },
  {
    question: "What is the repayment plan for the loan?",
    answer:
      "Repayment terms depend on the country you are studying in. For the US and Canada, the loan can be repaid in 10 years or less. For other countries, repayment can be made over a period of up to 20 years.",
  },
  {
    question: "What happens if my loan application is denied?",
    answer:
      "If your loan application is denied, Proconnect will provide feedback on areas to improve and offer guidance, particularly if the issue is related to a poor credit history.",
  },
  {
    question: "Can I bring my family with me after graduation?",
    answer:
      "Yes, students have the option to bring their families after graduation, depending on the visa and immigration laws of the respective country. However, we strongly advise against bringing your family immediately upon arrival with a study visa.",
  },
  {
    question: "Do I need a co-signer, collateral, or guarantor?",
    answer:
      "No, you do not need a co-signer, collateral, or guarantor to be eligible for our financing. We evaluate your present and future professional potential.",
  },
  {
    question: "Does Proconnect offer scholarships in addition to loans?",
    answer:
      "While Proconnect primarily focuses on loans, we can assist you in identifying scholarship opportunities during the application process. However, securing significant scholarships may require you to take exams like the GRE or GMAT.",
  },
  {
    question: "Is there a visa support service as part of the service package?",
    answer:
      "No, Proconnect is not an immigration expert or licensed visa consultant. We encourage candidates to seek guidance from immigration experts or visa consultants. However, we recommend a third-party partner for visa assistance, which is optional.",
  },
  {
    question: "What happens after I receive the final loan approval?",
    answer:
      "Once your loan is approved, you'll proceed to the visa application stage, and a financial support letter will be issued to help secure your student visa.",
  },
  {
    question: "Can I apply for the loan if I am pursuing a part-time course?",
    answer: "The loan is primarily aimed at full-time study programs.",
  },
  {
    question: "Are online or distance learning programs eligible for the loan?",
    answer:
      "No, the Proconnect International Student Loan typically supports in-person and in-country study programs only.",
  },
  {
    question: "What kind of support does Proconnect offer during my studies?",
    answer:
      "Proconnect provides ongoing support throughout your studies, including check-ins to ensure your progress and financial well-being.",
  },
  {
    question:
      "Are there any service fees charged by Proconnect to access its services?",
    answer:
      "Yes, a service fee of N200,000 (or $158) is charged for admission and loan processing. If you already have admission to a Proconnect-approved school and course, the fee is reduced to N158,000 (or $128).",
  },
  {
    question:
      "Can the loan be extended if I need more time to complete my studies?",
    answer:
      "No, the loan cannot be extended beyond the two-year timeline. It is important to focus on your academics and ensure that you graduate within the allotted time.",
  },
  {
    question: "Does Proconnect have specific universities it works with?",
    answer:
      "Yes, Proconnect partners with select universities around the world to provide loan services. A full list of partner universities is available at https://proconnectpay.com/supported-schools.",
  },
  {
    question:
      "What happens if I need to change my university or course after receiving the loan?",
    answer:
      "If you need to change your course but remain at the same university, Proconnect will re-evaluate your loan. However, transferring to a different university after the loan is disbursed is not permitted.",
  },
  {
    question:
      "Can I use the loan to cover health insurance costs while studying abroad?",
    answer:
      "Yes, the loan can be used to cover mandatory health insurance costs while studying abroad, but this applies only to the United States and selected Canadian universities that accept living expenses and health insurance.",
  },
  {
    question:
      "Does Proconnect offer counseling for budgeting and financial management while studying abroad?",
    answer:
      "No, Proconnect does not provide financial counseling. However, most universities have counseling centers that offer support and guidance on budgeting and financial management.",
  },
  {
    question: "What if I get a scholarship after my loan is approved?",
    answer:
      "If you receive a scholarship after your loan approval, the loan amount can be adjusted accordingly to cover only what is necessary.",
  },
  {
    question: "Are there any early repayment penalties for the loan?",
    answer:
      "No, there are no penalties for early repayment. You can pay off your loan earlier if you wish, and doing so may reduce the overall interest accrued.",
  },
  {
    question: "Can I apply for more than one loan to cover my studies?",
    answer:
      "No, Proconnect allows for only one loan per student. However, students can combine loans with scholarships or grants.",
  },
  {
    question: "What happens if I fail to complete my studies?",
    answer:
      "If you fail to complete your studies, you will still be required to repay the loan based on the amount disbursed and terms agreed upon during the loan agreement.",
  },
  {
    question: "Can I apply for the loan if I have already started my studies?",
    answer:
      "Yes, students who are already enrolled in a study program may apply for the loan, provided they meet other eligibility criteria.",
  },
  {
    question: "What is the grace period before I start repaying the loan?",
    answer:
      "The grace period for loan repayment typically begins after you complete your studies. The exact duration varies but is usually between 6 to 12 months.",
  },
  {
    question:
      "Can the loan cover undergraduate and postgraduate studies, including PhD?",
    answer:
      "Our loan only covers MSc and MBA programs. We do not fund PhD or bachelor's programs abroad. The maximum academic duration we finance is 24 months.",
  },
  {
    question: "What is the minimum loan amount I can apply for?",
    answer:
      "The minimum loan amount varies based on the destination country and course but typically starts at around $15,000.",
  },
  {
    question:
      "Can the loan be used for vocational or professional training programs?",
    answer:
      "No, we only finance degree-oriented MSc and MBA programs. To be eligible for our financing, you must be a Polytechnic HND or University BSc graduate.",
  },
  {
    question:
      "What kind of academic progress do I need to maintain to keep my loan in good standing?",
    answer:
      "You are expected to maintain satisfactory academic progress as defined by your university to remain eligible for continued loan support.",
  },
  {
    question:
      "Can I apply for the loan if I plan to study in a non-English-speaking country?",
    answer:
      "Yes, as long as the university and program meet Proconnect's criteria, you can apply for the loan even in non-English-speaking countries.",
  },
];
