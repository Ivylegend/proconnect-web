...
export default function ProgramMatters() {
  return (
    <div className="flex flex-col items-center">
      ...
      <h1 className="text-2xl text-gray-500 font-bold max-w-6xl text-center mb-10 mt-5">
          ...
          <div className="flex flex-col gap-3 mt-4">
            <div className="flex items-center gap-3">
              <span className="bg-red-600 p-3 rounded-full">
                <FaToolbox className="text-white text-3xl font-extrabold" />
              </span>
              <p className="text-xl">Get remote jobs that pay in dollars</p>
            </div>
            <div className="flex items-center gap-3">
              <span className="bg-red-600 p-3 rounded-full">
                <FaArrowTrendUp className="text-white text-3xl font-extrabold" />
              </span>
              <p className="text-xl">
            ...
            <div className="flex items-center gap-3">
              <span className="bg-red-600 p-3 rounded-full">
                <FaArrowUpFromBracket className="text-white text-3xl font-extrabold" />
              </span>
              <p className="text-xl">Apply for freelance or startup visas</p>
            </div>
            <div className="flex items-center gap-3">
              <span className="bg-red-600 p-3 rounded-full">
                <BsGlobeEuropeAfrica className="text-white text-3xl font-extrabold" />
              </span>
              <p className="text-xl">
