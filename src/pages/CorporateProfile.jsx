      ...
      <div className="py-4 px-6 lg:p-0">
        ...
        >
          ...
          >
            ...
            <p className="text-base md:text-xl leading-8 text-justify">
              ...
              makes studying abroad more accessible. Additionally, we streamline
              the relocation process by covering essential expenses such as
              flights, living costs, and rent, ensuring a smooth transition for
              individuals pursuing global opportunities. With our comprehensive
              approach and global partnerships, Proconnect empowers students and
              professionals to focus on their ambitions while we manage the
              financial logistics.
            </p>
          </motion.div>
          {/* TWO */}
        ...
        >
          ...
          >
            ...
            <p className="text-base md:text-xl leading-8 text-justify">
              ...
              providing innovative financial services and personalized support.
              We strive to break financial barriers to global education and
              mobility, ensuring our clients can focus on their aspirations
              while we manage the complexities of their journey.
            </p>
          </motion.div>
          {/* TWO */}
          <motion.div
        ...
        >
          ...
          >
            ...
            <p className="text-base md:text-xl leading-8 text-justify">
              To become the world's most trusted partner in transforming dreams
              of global education and mobility into reality by enabling seamless
              access to financial solutions and opportunities
            </p>
          </motion.div>
          {/* TWO */}
          <motion.div
